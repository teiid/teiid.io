...
- The [12.x](http://teiid.github.io/teiid-documents/12.2.x/content/) series of releases use gitbook, which can be used to download/generate PDF, EPUB, and MOBI documentation.
