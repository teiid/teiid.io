...
gulp.task('css', function () {
  return gulp.src('./themes/dracoio/scss/**/*.scss')
    .pipe(plugins.sass())
    .pipe(plugins.postcss())
    .pipe(gulp.dest('./themes/dracoio/static/css'));
});
gulp.task('css:watch', gulp.series('css', function () {
  gulp.watch('./themes/dracoio/scss/**/*.scss', gulp.series('css'));
}));

gulp.task('js', function () {
  return gulp.src(jsLibs)
    .pipe(plugins.concat('dracoio.js'))
    .pipe(gulp.dest('./themes/dracoio/static/js'));
});
...
gulp.task('fonts', function() {
  return gulp.src('./node_modules/font-awesome/fonts/*')
    .pipe(gulp.dest('./themes/dracoio/static/fonts'))
});
...
gulp.task('hugo', function (cb) {
  ...
  var baseURLArg = '';
  if (githubProject && githubProject !== "teiid" && process.env['CIRCLE_PROJECT_REPONAME']) {
